...
export default function BottomNav({ active, onChange }) {
  ...
  return (
    <nav style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: '#fff', borderTop: '0.5px solid #eee', display: 'flex', padding: '10px 0 max(14px, env(safe-area-inset-bottom))', zIndex: 100 }}>
      {tabs.map(t => (
